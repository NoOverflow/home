...
;(function oneko() {
  ...
  let nekoPosX = Math.random() * (window.innerWidth - 48) + 24
  let nekoPosY = Math.random() * (window.innerHeight - 48) + 24
  ...
  function init() {
    nekoEl.id = "oneko"
    nekoEl.setAttribute("data-persist", "true")
  ...
  function idle() {
    ...
    // every ~ 20 seconds
    if (idleTime > 10 && Math.floor(Math.random() * 80) == 0 && idleAnimation == null) {
